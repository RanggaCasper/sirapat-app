...
class MeetingMinuteModel extends MeetingMinute {
  ...
  factory MeetingMinuteModel.fromJson(Map<String, dynamic> json) {
    ...
    return MeetingMinuteModel(
      ...
      pembahasan: json['discussion'],
      keputusan: parseStringList(json['decisions']),
      tindakan: parseStringList(json['actions']),
      anggaran: parseAnggaran(json['budgets']),
      totalAnggaran: json['total_budget'],
      catatanAnggaran: json['budget_notes'],
