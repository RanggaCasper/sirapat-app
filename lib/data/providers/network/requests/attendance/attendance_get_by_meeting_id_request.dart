...
class AttendanceGetByMeetingIdRequest extends APIRequestRepresentable {
  final int meetingId;

  AttendanceGetByMeetingIdRequest({required this.meetingId});

  @override
  String get url => "${APIEndpoint.attendace}/$meetingId";

  @override
  String get endpoint => APIEndpoint.baseUrl;

  @override
  String get path => "/admin/attendance/$meetingId";
