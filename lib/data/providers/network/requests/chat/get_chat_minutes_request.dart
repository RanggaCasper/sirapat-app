...
class GetChatMinutesRequest implements APIRequestRepresentable {
  final int meetingId;

  GetChatMinutesRequest({required this.meetingId});

  @override
  String get url => "${APIEndpoint.chatMinutes}/$meetingId";

  @override
  String get endpoint => APIEndpoint.baseUrl;

  @override
  String get path => "/chat-minute/$meetingId";
