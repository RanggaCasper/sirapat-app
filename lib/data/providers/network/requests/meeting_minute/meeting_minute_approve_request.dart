...
class ApproveMeetingMinuteRequest implements APIRequestRepresentable {
  final int meetingMinuteId;

  ApproveMeetingMinuteRequest({required this.meetingMinuteId});

  @override
  String get url => "${APIEndpoint.meetingMinutes}/$meetingMinuteId/approve";

  @override
  String get endpoint => APIEndpoint.baseUrl;

  @override
  String get path => "/meeting-minutes/$meetingMinuteId/approve";
