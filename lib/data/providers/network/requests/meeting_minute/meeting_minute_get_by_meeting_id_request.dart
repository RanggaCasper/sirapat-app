...
class GetMeetingMinuteByMeetingIdRequest implements APIRequestRepresentable {
  final int meetingId;

  GetMeetingMinuteByMeetingIdRequest({required this.meetingId});

  @override
  String get url => "${APIEndpoint.meetingMinutes}/$meetingId/find-meeting";

  @override
  String get endpoint => APIEndpoint.baseUrl;

  @override
  String get path => "/meeting-minute/$meetingId/find-meeting";
