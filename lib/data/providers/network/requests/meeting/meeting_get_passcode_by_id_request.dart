...
class GetPasscodeByIdRequest implements APIRequestRepresentable {
  final int id;

  GetPasscodeByIdRequest({required this.id});

  @override
  String get url => "${APIEndpoint.meetings}/get-passcode/$id";

  @override
  String get endpoint => APIEndpoint.baseUrl;

  @override
  String get path => "/meeting/get-passcode/$id";
